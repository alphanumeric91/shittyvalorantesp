...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas) :BackgroundDrawList(&DrawListSharedData), ForegroundDrawList(&DrawListSharedData),OverlayDrawList(NULL)
    {
        Initialized = false;
...
namespace ImGui
{
    ...
    IMGUI_API bool          TabEx(const char* label, const char* second_label, int number, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          SubTabEx2(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
