...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginNigger(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          BeginNiggerChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          SelectionButton(bool active, const char* label, const ImVec2& size = ImVec2(0, 0));    // button
    IMGUI_API bool          SmallButton(const char* label);                                 // button with FramePadding=(0,0) to easily embed within text
    IMGUI_API bool          InvisibleButton(const char* str_id, const ImVec2& size);        // button behavior without the visuals, useful to build custom behaviors using the public api (along with IsItemActive, IsItemHovered, etc.)
    IMGUI_API bool          ArrowButton(const char* str_id, ImGuiDir dir);                  // square button with an arrow shape
    IMGUI_API void          Image(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0,0), const ImVec2& uv1 = ImVec2(1,1), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0,0,0,0));
    IMGUI_API bool          ImageTabButton(ImTextureID user_texture_id, const ImVec2& size, const bool active = false, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));    // <0 frame_padding uses default frame padding settings. 0 for no padding
    ...
    IMGUI_API bool          Tab(const char* label, const char* second_label, int number, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          SubTab(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          SubTab2(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
